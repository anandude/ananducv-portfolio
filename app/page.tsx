      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16">
            ...
            <div className="space-y-8 sm:space-y-12">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Assisted teaching JavaScript, C, and C++; mentored students through projects, problem‑solving, and debugging.",
                  tech: ["JavaScript", "C", "C++"],
                },
              ].map((job, index) => (
                <div
        ...
        >
          <div className="space-y-12 sm:space-y-16">
            ...
            <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
              {[
                {
                  title: "Merged a PR into Hoppscotch",
                  excerpt:
                    "Contributed to a 74k+ star open‑source project. Takeaway: strong fundamentals make cross‑framework work smooth.",
                  date: "Sep 2025",
                  readTime: "3 min",
                  url: "https://www.linkedin.com/feed/update/urn:li:activity:7377268160229593088/",
                },
                {
                  title: "Comet: finding student discounts fast",
                  excerpt:
                    "A minimalist tool that surfaced a working student discount in under 10 seconds—notes on speed and utility.",
                  date: "Aug 2025",
                  readTime: "2 min",
                  url: "https://www.linkedin.com/feed/update/urn:li:activity:7370790890287583232/",
                },
                {
                  title: "Zecrypt is live",
                  excerpt:
                    "Launching a zero‑knowledge encrypted vault—privacy by default, open‑source, user‑owned keys.",
                  date: "Jun 2025",
                  readTime: "4 min",
                  url: "https://www.linkedin.com/feed/update/urn:li:activity:7338088536635490305/",
                },
                {
                  title: "Learning Something New? What Works",
                  excerpt: "A practical framework I use to learn efficiently and retain more over time.",
                  date: "May 2025",
                  readTime: "6 min",
                  url: "https://medium.com/@ananducv/learning-something-new-heres-what-actually-works-f4f83af8b065",
                },
              ].map((post, index) => (
                <Link
                  href={post.url}
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Link
                    href="mailto:ananducv666@gmail.com"
                    className="group flex items-center gap-3 text-foreground hover:text-muted-foreground transition-colors duration-300"
                  >
                    <span className="text-base sm:text-lg">ananducv666@gmail.com</span>
                    <svg
        ...
        <footer className="py-12 sm:py-16 border-t border-border">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
            <div className="space-y-2">
              <div className="text-sm text-muted-foreground">© 2026 Anandakrishnan CV. All rights reserved.</div>
              <div className="text-xs text-muted-foreground">Built by Anandakrishnan CV</div>
            </div>
